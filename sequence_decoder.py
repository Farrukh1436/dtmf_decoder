...
class SequenceDecoder:
    ...
    def extract_sequence(self, signal, win_ms=100, hop_ms=None, pwr_thr=1e-4, pk_thr=2.0, min_hits=2):
        ...
        for pos in range(0, len(norm_sig) - win_len + 1, hop_len):
            ...
            current = self.analyzer.identify_digit(window, min_power=pwr_thr, peak_ratio=pk_thr)
        ...
        for char, (t_start, t_end) in zip(results[1:], intervals[1:]):
        ...
        return "".join(consolidated), consol_times
